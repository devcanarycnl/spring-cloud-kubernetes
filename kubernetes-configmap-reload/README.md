...
-------
    git clone https://github.com/devcanarycnl/spring-cloud-kubernetes.git
...
--------------
    docker build -t devcanarycnl/kubernetes-configmap-reload .
...
-----------
    docker push devcanarycnl/kubernetes-configmap-reload
